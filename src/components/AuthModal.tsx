  ...
  return (
    ...
    >
      ...
      >
        ...
        {errorText && (
          <div style={{ backgroundColor: '#fee2e2', color: '#ef4444', padding: '12px', borderRadius: '8px', fontSize: '0.9rem', textAlign: 'left' }}>
            {errorText}
          </div>
        )}

        {successText && (
          <div style={{ backgroundColor: '#dcfce7', color: '#166534', padding: '12px', borderRadius: '8px', fontSize: '0.9rem', textAlign: 'left' }}>
            {successText}
          </div>
        )}
        ...
        {view === 'options' && (
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <button onClick={handleAppleSignIn} style={{...buttonStyle, backgroundColor: "#000000", color: "#ffffff", borderColor: "#000000"}} disabled={loading}>
            ...
            <button onClick={() => setView('email_signin')} style={{...buttonStyle, backgroundColor: "#f8fafc"}} disabled={loading}>
              <svg style={{ width: "24px", height: "24px", fill: "#475569" }} viewBox="0 0 24 24">
        ...
        {view === 'email_signin' && (
          <form onSubmit={handleEmailSignIn} style={{ display: "flex", flexDirection: "column" }}>
            ...
            <p style={{ marginTop: "20px", fontSize: "0.9rem", color: "#475569" }}>
              Don't have an account?{' '}
              <span onClick={() => {setView('email_signup'); setErrorText(null);}} style={{ color: "#3b82f6", cursor: "pointer", fontWeight: 600 }}>
                Sign Up
              </span>
            </p>
          </form>
        ...
        {view === 'email_signup' && (
          <form onSubmit={handleEmailSignUp} style={{ display: "flex", flexDirection: "column" }}>
            ...
            <p style={{ marginTop: "20px", fontSize: "0.9rem", color: "#475569" }}>
              ...
              <span onClick={() => {setView('email_signin'); setErrorText(null);}} style={{ color: "#3b82f6", cursor: "pointer", fontWeight: 600 }}>
                Sign In
              </span>
            </p>
          </form>
        ...
        {view === 'forgot_password' && (
          <form onSubmit={handlePasswordReset} style={{ display: "flex", flexDirection: "column" }}>
            ...
            <p style={{ marginTop: "20px", fontSize: "0.9rem", color: "#475569" }}>
              ...
              <span onClick={() => {setView('email_signin'); setErrorText(null); setSuccessText(null);}} style={{ color: "#3b82f6", cursor: "pointer", fontWeight: 600 }}>
                Sign In
              </span>
            </p>
          </form>
