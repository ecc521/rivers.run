...
;// CONCATENATED MODULE: ./node_modules/@ionic-native/web-server/index.js
var web_server_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var WebServerOriginal = /** @class */ (function (_super) {
    web_server_extends(WebServerOriginal, _super);
...
//# sourceMappingURL=data:application/json;base64,
...
module.exports = function () {
  ...
  if (((_Capacitor = Capacitor) === null || _Capacitor === void 0 ? void 0 : _Capacitor.getPlatform()) === "ios") {
    try {
      ;

      _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
        var req, res, latestVersion, deviceInfo, currentVersion, popup, closeButton;
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch("https://itunes.apple.com/lookup?bundleId=run.rivers.twa&YourCDNDoesNotChangeCORSHeadersSoMustCacheBust" + Math.random());
...
module.exports = function (_ref) {
  ...
  window.addEventListener("message", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(event) {
      var data, response, unusedProps, stor, prop, index;
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", console.error("Origin Not Allowed: ", event.origin));
            ...
            case 9:
              ...
              unusedProps = Object.keys(localStorage);
              stor = JSON.parse(data.args[0]);

              for (prop in stor) {
                index = unusedProps.indexOf(prop);

                if (index !== -1) {
                  unusedProps.splice(index, 1);
                }

                localStorage.setItem(prop, stor[prop]);
              }

              unusedProps.forEach(function (unusedProp) {
            ...
            case 16:
              if (!(data.type === "getCurrentPosition")) {
                _context.next = 22;
                break;
              }

              _context.next = 19;
              return Capacitor.Plugins.Geolocation.getCurrentPosition();

            case 19:
              response.message = _context.sent;
              _context.next = 23;
              break;
...
try {
  if (!document.querySelector("link[rel='shortcut icon']")) {
    ...
    sizes.forEach(function (size) {
      ...
      favicon.href = root + "resources/icons/".concat(size, "x").concat(size, "-Water-Drop.png");
...
var _Capacitor, _Capacitor$Plugins, _Capacitor$Plugins$Ap;
...
var WebServer = (__webpack_require__(2689)/* .WebServer */ .G);

var enableUniversalLinks = __webpack_require__(4700);

var enableFrameBridge = __webpack_require__(5931);

var appUpdateWarning = __webpack_require__(7040);

var port = 15376;
var sourceServer = "https://rivers.run";
var preinstalledAssetsPath = "www"; //We host preinstalled assets in a www dir.

var localCacheAssetsPath = "filecache";

__webpack_require__(1466); //Add meta tags, etc.


function restartWebserver(callback) {
  console.log("Starting Webserver");
  return WebServer.stop().then(function () {
    WebServer.onRequest().subscribe(function (data) {
      ...
      if (!headers['Content-Type'] || data.path.includes("node") || data.path.includes("gaugeReadings")) {
        console.log("Redirecting to Network", data.path); //This server plugin only supports text, not binary.
        ...
        return WebServer.sendResponse(data.requestId, res).catch(function (error) {
      ...
      _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                _context.next = 7;
                return new Promise(function (resolve, reject) {
                  fetch(sourceServer + data.path).then(function (response) {
              ...
              case 18:
                ...
                _context.next = 23;
                return fetch(preinstalledAssetsPath + data.path);
              ...
              case 33:
                _context.prev = 33;
                console.log(res);
                WebServer.sendResponse(data.requestId, res).catch(function (error) {
                  return console.error(error);
                });
        ...
        }, _callee, null, [[0, 29, 33, 37], [2, 9], [12, 18]]);
      }))();
    });
    WebServer.start(port).catch(function (error) {
      return console.error(error);
    });
    callback();
  });
...
(_Capacitor = Capacitor) === null || _Capacitor === void 0 ? void 0 : (_Capacitor$Plugins = _Capacitor.Plugins) === null || _Capacitor$Plugins === void 0 ? void 0 : (_Capacitor$Plugins$Ap = _Capacitor$Plugins.App) === null || _Capacitor$Plugins$Ap === void 0 ? void 0 : _Capacitor$Plugins$Ap.addListener("appStateChange", function (event) {
...
restartWebserver(function () {
  ...
  var iframeUrl = "http://127.0.0.1:" + port;
  enableFrameBridge({
    iframeUrl: iframeUrl
  });
...
appUpdateWarning(); //Capacitor hides the accessory bar (the up/down, and done button) to make it less obvious apps use web tech.
//We'll show it again - rivers.run is pretty obviously web based anyways.

Capacitor.Plugins.Keyboard.setAccessoryBarVisible({
  isVisible: true
});
})();
